    ...
    try {
        ...
        await pool.query(
            ...
            CREATE TABLE IF NOT EXISTS users (
                ...
                dashboardPermissions JSON NULL,
                job VARCHAR(20),
                avatar CHAR(40),
        ...
        console.log('shiftRecordAuditLogs creada');
        ...
        console.log('serviceScheduleEmployeeOrders creada');
        ...
        console.log('shiftRecordCorrectionRequests creada');
        ...
        await pool.query(
            ...
            CREATE TABLE IF NOT EXISTS shiftSwapRequests (
                id CHAR(36) PRIMARY KEY NOT NULL,
                serviceId CHAR(36) NOT NULL,
                requestType ENUM('swap', 'transfer', 'request') DEFAULT 'swap',
                fromShiftId CHAR(36),
                toShiftId CHAR(36),
                fromShiftIds JSON,
                toShiftIds JSON,
                ...
                status ENUM('pending_counterpart', 'pending_admin', 'pending', 'approved', 'rejected') DEFAULT 'pending_counterpart',
                reason VARCHAR(255),
                decidedBy CHAR(36),
                decidedAt TIMESTAMP,
                createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        ...
        await pool.query(
            ...
            documentType ENUM('epi','information','dataProtection','contract','medical','riskAssessment','tax','other') NOT NULL DEFAULT 'other',
        ...
        await pool.query(
            ...
            CREATE TABLE IF NOT EXISTS acknowledgements (
                id CHAR(36) PRIMARY KEY NOT NULL,
                subjectType ENUM('communication','service_assignment','schedule','document','payroll','time_record') NOT NULL,
