...
router.post(
    '/services/:serviceId/schedule/import-excel',
    authUser,
    isAdmin,
    serviceExists,
...
router.get(
    '/services/:serviceId/schedule/employee-order',
    authUser,
    isAdmin,
    serviceExists,
    listServiceScheduleEmployeeOrderController
);
...
router.put(
    ...
    isAdmin,
    serviceExists,
    replaceServiceScheduleEmployeeOrderController
);
