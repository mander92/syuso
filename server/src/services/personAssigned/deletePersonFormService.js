...
const deletePersonFormService = async (serviceId, employeeId) => {
    const pool = await getPool();

    pool.query(`
        DELETE FROM personsAssigned WHERE serviceId = ? AND employeeId = ?
...
export default deletePersonFormService;